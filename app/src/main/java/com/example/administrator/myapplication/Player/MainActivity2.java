...
import static com.example.administrator.myapplication.Activity.MainActivity.src;
...
//        int orientation = OrientationUtil.getOrientation(MainActivity2.this);
//        if (orientation == OrientationUtil.HORIZONTAL) {
//            OrientationUtil.forceOrientation(MainActivity2.this, OrientationUtil.VERTICAL);
//        } else {
//            finish();
            onDestroy();
//        }
